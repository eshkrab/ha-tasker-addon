...
class nt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let n=i._$litPart$;if(void 0===n){const t=s?.renderBefore??null;i._$litPart$=n=new Q(e.insertBefore(U(),t),t,void 0,s??{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}}nt._$litElement$=!0,nt.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:nt});const rt=globalThis.litElementPolyfillSupport;rt?.({LitElement:nt}),(globalThis.litElementVersions??=[]).push("4.1.1");customElements.define("tasker-task-list-card",class extends nt{static get properties(){return{hass:{},config:{}}}static get styles(){return r`
    ...
    `}constructor(){super(),this.config={}}set hass(t){this._hass=t}setConfig(t){this.config={title:t.title||"My Tasks"}}_getTasks(){return this._hass?Object.values(this._hass.states).filter((t=>t.entity_id.startsWith("tasker."))):[]}_calculateDaysUntil(t){if(!t)return"N/A";const e=new Date,s=new Date(t)-e;return Math.ceil(s/864e5)}_computeSubtext(t){const e=t.attributes||{},s=this._calculateDaysUntil(e.next_due_date),i=e.last_done;let n="";return i&&(n+=`Last done: ${i}`),"N/A"!==s&&(n&&(n+=" • "),n+=`Due in ${s} day${1===s?"":"s"}`),n||(n=t.state),n}_computeLeftIcon(t){switch(t.state){case"done":return"mdi:check-circle";case"overdue":return"mdi:alert-circle";case"pending":return"mdi:timer-sand";default:return"mdi:check-circle-outline"}}_editTask(t){console.log("Edit clicked for",t.entity_id)}_markTaskDone(t){const e=String(t.attributes.task_id||t.entity_id.split(".")[1]);this._hass.callService("tasker","mark_task_done",{task_id:e})}_deleteTask(t){const e=String(t.attributes.task_id||t.entity_id.split(".")[1]);this._hass.callService("tasker","delete_task",{task_id:e})}render(){const t=this._getTasks();return I`
